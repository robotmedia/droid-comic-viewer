...
public class Compress {
	...
	public static int MAXWINSIZE    			= 0x100000;
	// public static final int MAXWINSIZE    	= 0x400000;
	public static int MAXWINMASK      			= (MAXWINSIZE-1);
	...
	public static final void adjustWindowSize(boolean full) {
		MAXWINSIZE = full ? 0x400000 : 0x100000;
