...
public class Browse extends ExtendedActivity {
	   ...
	   public class ImageAdapter extends BaseAdapter {
	        ...
	        public View getView(int position, View convertView, ViewGroup parent) {
	        	...
	        	if (thumbnail == null) {
		            ...
		            int thumbnailWidth = Utils.dipToPixel(mContext, THUMBNAIL_WIDTH_DIP);
		            int thumbnailHeight = Utils.dipToPixel(mContext, THUMBNAIL_HEIGTH_DIP);
