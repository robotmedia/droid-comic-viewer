...
import net.androidcomics.acv.SubscribeActivity;
...
public class SupportSettings extends ExtendedPreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		subscribe.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				Intent myIntent = new Intent(SupportSettings.this, SubscribeActivity.class);
